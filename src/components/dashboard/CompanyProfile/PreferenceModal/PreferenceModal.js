            ...
            <Dialog className='preference__modal' fullScreen open={open} onClose={() => close(false)}>
                <div className='preference__modal__container'>
                    ...
                    <div className='preference__modal__roles'>
                        ...
                        <div>
                            {pref?.map((pref, ind) => <p key={ind} className={ selected?.includes(pref) ? 'preference__modal__roles__role__selected' : 'preference__modal__roles__role'} onClick={() => set(pref)}>{pref}</p>)}
                        </div>
                    </div>
                </div>
            </Dialog>
